...
class GuruController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->has('data')) {
            $data = $request->data;
            $guru->where(function($query) use ($data) {
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('guru.home')->with('success', 'Berhasil Menambahkan Data Pengguna !');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('guru.home')->with('success', 'Proses Berhasil Dijalankan !');
    }
